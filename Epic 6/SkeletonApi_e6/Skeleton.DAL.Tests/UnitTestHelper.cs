...
{
    public static DbContextOptions<QuizHubDatabaseContext> GetUnitTestsDbOptions()
    {
        var options = new DbContextOptionsBuilder<QuizHubDatabaseContext>()
            .UseInMemoryDatabase(Guid.NewGuid().ToString())
            .Options;

        using (var context = new QuizHubDatabaseContext(options))
        {
            SeedData(context);
        }
    ...
    public static void SeedData(QuizHubDatabaseContext context)
    {
